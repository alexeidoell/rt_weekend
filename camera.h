...
private:
    ...
    double pixel_samples_scale = 1.0 / samples_per_pixel / threads;
    ...
    std::array<std::array<color3, image_width * image_height>, threads> thread_buffers{};
    std::array<color3, image_width * image_height> result{};
    ...
    void thread_render(std::array<color3, image_width * image_height>& buffer, const hittable& world) {
